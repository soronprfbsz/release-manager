...
log_info "실행: 1.patch_mariadb_ddl.sql"
execute_sql "1.patch_mariadb_ddl.sql"
log_info "실행: 2.patch_mariadb_dml.sql"
execute_sql "2.patch_mariadb_dml.sql"
cd ..
...
execute_sql_string "INSERT INTO release_version_history (release_version_id, standard_version, custom_version, version_created_at, version_created_by, system_applied_by, system_applied_at, comment) VALUES ('1.1.0', '1.1.0', NULL, '2025-10-31 00:00:00', 'jhlee@tscientific', 'patch_script', NOW(), '데이터코드, 이벤트코드, 메뉴코드 추가 / SMS 기능 추가 / VERSION_HISTORY 테이블 추가 / V_INFO_MCH 관련 뷰 변경') ON DUPLICATE KEY UPDATE system_applied_at = NOW();"
log_info "RELEASE_VERSION_HISTORY 업데이트: 1.1.0"
execute_sql_string "INSERT INTO release_version_history (release_version_id, standard_version, custom_version, version_created_at, version_created_by, system_applied_by, system_applied_at, comment) VALUES ('1.1.1', '1.1.1', NULL, '2025-11-05 00:00:00', 'jhlee@tscientific', 'patch_script', NOW(), '운영관리 - 파일 기능 관련 테이블 추가') ON DUPLICATE KEY UPDATE system_applied_at = NOW();"
log_info "RELEASE_VERSION_HISTORY 업데이트: 1.1.1"
execute_sql_string "INSERT INTO release_version_history (release_version_id, standard_version, custom_version, version_created_at, version_created_by, system_applied_by, system_applied_at, comment) VALUES ('1.1.2', '1.1.2', NULL, '2025-11-25 00:00:00', 'jhlee@tscientific', 'patch_script', NOW(), 'SMS 로그 모니터링 정책 상세 테이블 추가') ON DUPLICATE KEY UPDATE system_applied_at = NOW();"
log_info "RELEASE_VERSION_HISTORY 업데이트: 1.1.2"
