...
,('STD204','이벤트','Event','STD200',0,'Y','',2,'/event/monitor','Y')
,('STD205','로그','System Log','STD200',1,'Y','',2,'/event/log','Y')
,('STD206','실시간','Real time event','STD204',0,'Y','',3,'/event/monitor/realtime','Y')
,('STD207','이벤트 이력','Event history','STD204',1,'Y','',3,'/event/monitor/history','Y')
,('STD208','조치이력','Action history','STD204',2,'Y','',3,'/event/monitor/actionHistory','Y')
,('STD209','예외시간','Exception time','STD204',3,'Y','',3,'/event/monitor/exceptionTime','Y')
,('STD210','Syslog','Syslog','STD205',0,'Y','',3,'/event/log/syslog','Y')
,('STD211','Trap','Trap','STD205',1,'Y','',3,'/event/log/trap','Y')
...
,('STD304','목록','List','STD300',0,'Y','',2,'/sms/list','Y')
,('STD305','요약','Overview','STD300',1,'Y','',2,'/sms/overview','Y')
,('STD306','운영관리','Operation Management','STD300',2,'Y','',2,'/sms/operation','Y')
,('STD307','정책관리','Policy Management','STD300',3,'Y','',2,'/sms/policy','Y')
,('STD308','기본','Basic','STD304',0,'Y','',3,'/sms/list/basic','Y')
,('STD309','요약','Summary','STD304',1,'Y','',3,'/sms/list/summary','Y')
,('STD310','성능','Performance','STD304',2,'Y','',3,'/sms/list/perf','Y')
,('STD311','저장장치','Storage','STD304',3,'Y','',3,'/sms/list/storage','Y')
,('STD312','프로세스','Process','STD304',4,'Y','',3,'/sms/list/process','Y')
,('STD313','네트워크','Network','STD304',5,'Y','',3,'/sms/list/network','Y')
,('STD314','서비스','Service','STD304',6,'Y','',3,'/sms/list/service','Y')
,('STD315','에이전트','Agent','STD306',0,'Y','',3,'/sms/operation/agent','Y')
,('STD316','파일','File','STD306',1,'Y','',3,'/sms/operation/file','Y')
,('STD317','프로세스','Process','STD306',2,'Y','',3,'/sms/operation/process','Y')
,('STD318','서비스','Service','STD306',3,'Y','',3,'/sms/operation/service','Y')
,('STD319','에이전트','Agent','STD307',0,'Y','',3,'/sms/policy/agent','Y')
,('STD320','이벤트','Event','STD307',1,'Y','',3,'/sms/policy/event/tmpl','Y')
,('STD321','프로세스','Process','STD307',2,'Y','',3,'/sms/policy/process','Y')
,('STD322','이벤트 예외시간','Event Exclusion Time','STD307',3,'Y','',3,'/sms/policy/eventExclusion','Y')
,('STD323','로그','log','STD306',4,'Y','',3,'/sms/operation/log','Y');
