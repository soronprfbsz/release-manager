...
CREATE TABLE infraeye.server_metric_file (
	"collected_at" TIMESTAMP WITH TIME ZONE NOT NULL,
	...
	"object_size" varchar,
	"object_permissions" varchar,
	"object_owner" varchar,
	"object_last_modified_at" TIMESTAMP WITH TIME ZONE,
	"num_of_objects" INTEGER,
...
CREATE TABLE infraeye.server_metric_service (
	"collected_at" TIMESTAMP WITH TIME ZONE NOT NULL,
	"partition_day" VARCHAR,
	"policy_id" INTEGER,
	"status" VARCHAR,
