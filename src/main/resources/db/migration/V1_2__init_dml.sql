...
-- ==========================================2025-12-24T11:05:14.109+09:00 ERROR 41108 --- [nio-8081-exec-1] c.t.r.d.f.service.FileSyncService        : 액션 처리 실패: d0688cee-ff05-4a7b-a863-a48ae80bea2c - REGISTER

com.ts.rm.global.exception.BusinessException: 릴리즈 파일 등록에는 releaseVersionId가 필요합니다
	at com.ts.rm.domain.releasefile.filesync.ReleaseFileSyncAdapter.registerFile(ReleaseFileSyncAdapter.java:69) ~[main/:na]
	...
	at com.ts.rm.domain.releasefile.filesync.ReleaseFileSyncAdapter$$SpringCGLIB$$0.registerFile(<generated>) ~[main/:na]
	at com.ts.rm.domain.filesync.service.FileSyncService.processAction(FileSyncService.java:466) ~[main/:na]
	at com.ts.rm.domain.filesync.service.FileSyncService.apply(FileSyncService.java:171) ~[main/:na]
	at java.base/jdk.internal.reflect.NativeMethodAccessorImpl.invoke0(Native Method) ~[na:na]
	at java.base/jdk.internal.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:77) ~[na:na]
	at java.base/jdk.internal.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:43) ~[na:na]
	at java.base/java.lang.reflect.Method.invoke(Method.java:568) ~[na:na]
	...
	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:184) ~[spring-aop-6.2.11.jar:6.2.11]
	at org.springframework.aop.framework.CglibAopProxy$DynamicAdvisedInterceptor.intercept(CglibAopProxy.java:728) ~[spring-aop-6.2.11.jar:6.2.11]
	at com.ts.rm.domain.filesync.service.FileSyncService$$SpringCGLIB$$0.apply(<generated>) ~[main/:na]
	at com.ts.rm.domain.filesync.controller.FileSyncController.apply(FileSyncController.java:84) ~[main/:na]
	at java.base/jdk.internal.reflect.NativeMethodAccessorImpl.invoke0(Native Method) ~[na:na]
	at java.base/jdk.internal.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:77) ~[na:na]
	at java.base/jdk.internal.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:43) ~[na:na]
	at java.base/java.lang.reflect.Method.invoke(Method.java:568) ~[na:na]
	...
	at org.apache.catalina.core.ApplicationFilterChain.internalDoFilter(ApplicationFilterChain.java:164) ~[tomcat-embed-core-10.1.46.jar:10.1.46]
	at org.apache.catalina.core.ApplicationFilterChain.doFilter(ApplicationFilterChain.java:140) ~[tomcat-embed-core-10.1.46.jar:10.1.46]
	at com.ts.rm.global.filter.ApiLoggingFilter.doFilterInternal(ApiLoggingFilter.java:48) ~[main/:na]
	...
	at org.springframework.security.web.ObservationFilterChainDecorator$ObservationFilter.doFilter(ObservationFilterChainDecorator.java:228) ~[spring-security-web-6.5.5.jar:6.5.5]
	at org.springframework.security.web.ObservationFilterChainDecorator$VirtualFilterChain.doFilter(ObservationFilterChainDecorator.java:138) ~[spring-security-web-6.5.5.jar:6.5.5]
	at com.ts.rm.global.filter.JwtAuthenticationFilter.doFilterInternal(JwtAuthenticationFilter.java:71) ~[main/:na]
	at org.springframework.web.filter.OncePerRequestFilter.doFilter(OncePerRequestFilter.java:116) ~[spring-web-6.2.11.jar:6.2.11]
	at org.springframework.security.web.ObservationFilterChainDecorator$ObservationFilter.wrapFilter(ObservationFilterChainDecorator.java:241) ~[spring-security-web-6.5.5.jar:6.5.5]
	at org.springframework.security.web.ObservationFilterChainDecorator$ObservationFilter.doFilter(ObservationFilterChainDecorator.java:228) ~[spring-security-web-6.5.5.jar:6.5.5]
	at org.springframework.security.web.ObservationFilterChainDecorator$VirtualFilterChain.doFilter(ObservationFilterChainDecorator.java:138) ~[spring-security-web-6.5.5.jar:6.5.5]
...
2025-12-24T11:05:14.111+09:00  INFO 41108 --- [nio-8081-exec-1] c.t.r.d.f.service.FileSyncService        : 파일 동기화 적용 완료 - 성공 0건, 실패 1건
2025-12-24T11:05:14.112+09:00 ERROR 41108 --- [nio-8081-exec-1] c.t.r.g.e.GlobalExceptionHandler         : Unexpected error occurred
...
2025-12-24T11:05:14.113+09:00  WARN 41108 --- [nio-8081-exec-1] .m.m.a.ExceptionHandlerExceptionResolver : Resolved [org.springframework.transaction.UnexpectedRollbackException: Transaction silently rolled back because it has been marked as rollback-only]
2025-12-24T11:05:14.113+09:00 DEBUG 41108 --- [nio-8081-exec-1] c.ts.rm.global.filter.ApiLoggingFilter   :
╔════════════════════════════════════════════════════════════════
║ API Request: [POST] /api/file-sync/apply
╠════════════════════════════════════════════════════════════════
║ Request Body: {"actions":[{"id":"d0688cee-ff05-4a7b-a863-a48ae80bea2c","action":"REGISTER"}]}
╠════════════════════════════════════════════════════════════════
║ API Response: [POST] /api/file-sync/apply
╠════════════════════════════════════════════════════════════════
║ Status: 500
║ Duration: 5ms
║ Response Body: {"status":"error","data":{"code":"C002","message":"서버 오류가 발생했습니다","detail":null}}
╚════════════════════════════════════════════════════════════════
===============
-- account 테이블
-- =========================================================
...
INSERT INTO service_component (service_id,component_type,component_name,host,port,url,ssh_port,description,sort_order,is_active,created_by) VALUES
